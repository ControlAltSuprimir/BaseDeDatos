...
class proyectosactividad extends Component
{
    ...
    public function render()
    {
        return view('livewire.modals.proyectosactividad', [
            'products' => ($this->type == 1) ? ProyectosActividadesAcademicas::where('is_valid', '=', 1)->where('id_academica', '=', $this->items)->latest()->paginate(10) : PersonasActividadesExtension::where('is_valid', '=', 1)->where('id_actividad', '=', $this->items)->latest()->paginate(10)
        ]);
    }
