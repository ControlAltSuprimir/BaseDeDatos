<div>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody>
                          ...
                          {{$persona}}
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                        {{ $product->programa->grado }}
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                        {{ $product->estadoDelPrograma() }}
                                    </td>
    ...
    <div class="@if (!$showModal) hidden @endif flex items-center
            ...
            <form wire:submit.prevent="save" class="w-full">
                ...
                <div class="bg-white py-6 px-4 sm:p-6">
                    <div class="col-span-4 sm:col-span-1" gap-6>
                        ...
                        <select wire:model.defer="product.id_Programa"
                    ...
                    <div class="mt-6 grid grid-cols-4 gap-6">
                        <div class="col-span-4 sm:col-span-2">
                            <label for="first_name" class="block text-sm font-medium text-gray-700">Fecha
                                Comienzo</label>
                            <input type="date" autocomplete="cc-given-name"
                                class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-gray-900 focus:border-gray-900 sm:text-sm"
                                wire:model.defer="product.fecha_comienzo">
                        </div>

                        <div class="col-span-4 sm:col-span-2">
                            <label for="last_name" class="block text-sm font-medium text-gray-700">Fecha Término</label>
                            <input type="date" autocomplete="cc-family-name"
                                class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-gray-900 focus:border-gray-900 sm:text-sm"
                                wire:model.defer="product.fecha_termino">
                        </div>

                        <div class="col-span-4 sm:col-span-2">
                            <label for="last_name" class="block text-sm font-medium text-gray-700">Distinción</label>
                            <input type="text" autocomplete="cc-family-name"
                                class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-gray-900 focus:border-gray-900 sm:text-sm"
                                wire:model.defer="product.distincion">
                        </div>
                        <div class="col-span-4 sm:col-span-2">
                            <label for="last_name" class="block text-sm font-medium text-gray-700">Estado</label>
                            <select wire:model.defer="product.estado"
                                class="mt-1 block w-full bg-white border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-gray-900 focus:border-gray-900 sm:text-sm">
                                <option value="">-- Selecciona el Programa --</option>
                            ...
                            {{-- 'activo','finalizado','noTerminado','congelado' --}}
                        </div>
                    </div>
                    <br>
                    <div class="col-span-4 sm:col-span-1" gap-6>
                        ...
                        <select wire:model.defer="product.id_programa_de_origen"
                            class="mt-1 block w-full bg-white border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-gray-900 focus:border-gray-900 sm:text-sm">
                            <option value="">-- Selecciona el Programa --</option>
                    ...
                    <div class="col-span-4 sm:col-span-2">
                        <label for="last_name" class="block text-sm font-medium text-gray-700">Escribe 1 si este grado
                            es maximal</label>
                        <input type="text" autocomplete="cc-family-name"
                            class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-gray-900 focus:border-gray-900 sm:text-sm"
                            wire:model.defer="product.es_maximo">
                    </div>
