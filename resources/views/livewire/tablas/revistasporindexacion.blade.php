                ...
                <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                <th {{--wire:click="sortBy('revistas.nombre')" style="cursor: pointer;"--}} scope="col"
                                    class="px-12 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                    Nombre de la Revista
                                    {{--
                                        @include('partials._sort-icon',['field'=>'revistas.nombre'])
                                    --}}
                                </th>
                            ...
                            @foreach ($items as $revista)
                                <tr class="bg-white">
                                    <td class="px-12 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                                        {!! $revista->laRevista->full_nameLink() !!}
                                    </td>
                  ...
                  {{$persona}}
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                        ...
                                        {!! $revista->impact_factor !!}
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                        {!! $revista->clasificacionQ !!}
                                    </td>
                                    <td scope="col"
                                        class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">

                                        {{ $revista->laRevista->numeroPublicaciones() }}
