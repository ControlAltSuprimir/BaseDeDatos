                            ...
                            @forelse ($products as $product)
                                ...
                                <tr class="bg-white">
                                    <td class="px-12 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                                        {!! $product->laPersona->full_nameLink() !!}
                                    </td>
                ...
                <div class="flex flex-col items-start p-4">
                    <div class="flex items-center w-full border-b pb-4">
                        <div class="text-gray-900 font-medium text-lg">
                            {{ $productId ? 'Editar Participación' : 'Añadir Participación' }}</div>
                    ...
                    <div class="mt-6 grid grid-cols-4 gap-6">
                        <div class="col-span-4 sm:col-span-2">
                            ...
                            <input type="date" autocomplete="cc-given-name"
                                ...
                                wire:model.defer="product.fecha">
                        </div>

                        <div class="col-span-4 sm:col-span-2">
                            <label for="last_name" class="block text-sm font-medium text-gray-700">Tipo de Participación</label>
                            <select wire:model.defer="product.participacion"
                                class="mt-1 block w-full bg-white border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-gray-900 focus:border-gray-900 sm:text-sm">
                                <option value=0>Asociado(a)</option>
                                <option value=1>Coinvestigador(a)</option>
                                <option value=2>Colaborador(a)</option>
                                <option value=3>Co Responsable</option>
                                <option value=4>Patrocinante</option>
...
<br>
                    <div class="col-span-4 sm:col-span-2">
                        <label for="last_name" class="block text-sm font-medium text-gray-700">Describe la participación en caso de que sea necesario</label>
                        <input type="text" autocomplete="cc-family-name"
                            class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-gray-900 focus:border-gray-900 sm:text-sm"
                            wire:model.defer="product.descripcionParticipacion">
                    </div>
