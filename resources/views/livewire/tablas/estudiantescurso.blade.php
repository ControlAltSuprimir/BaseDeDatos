                            ...
                            @forelse ($products as $product)
                                ...
                                <tr class="bg-white">
                                    <td class="px-12 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                                        {!! $product->alumno->full_nameEstudianteLink() !!}
                                    </td>
                ...
                <div class="flex flex-col items-start p-4">
                    <div class="flex items-center w-full border-b pb-4">
                        <div class="text-gray-900 font-medium text-lg">
                            {{ $productId ? 'Editar Estudiante' : 'Añadir Estudiante' }}</div>
                ...
                <div class="bg-white py-6 px-4 sm:p-6">
                    <div class="col-span-4 sm:col-span-1" gap-6>
                        ...
                        <select wire:model.defer="product.id_persona"
                            ...
                            @foreach ($allPersonas as $programa)
                    ...
                    <div class="mt-6 grid grid-cols-4 gap-6">
                        <div class="col-span-4 sm:col-span-2">
                            <label for="first_name" class="block text-sm font-medium text-gray-700">Nota Final (de 1.0 a
                                7.0)</label>
                        ...
                        <div class="col-span-4 sm:col-span-2">
                            <label for="last_name" class="block text-sm font-medium text-gray-700">Porcentaje de
                                Asistencia (de 0.0 a 100.0)</label>
