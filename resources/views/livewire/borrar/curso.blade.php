                    ...
                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                        ...
                        <div class="mt-2">
                            <p class="text-sm text-gray-500">
                                ¿Estás seguro(a) que quieres borrar este curso? Todos los datos serán relacionados a
                                este curso serán permanentemente removidos de la base de datos como también el registro
