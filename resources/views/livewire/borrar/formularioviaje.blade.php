                    ...
                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                        ...
                        <div class="mt-2">
                            <p class="text-sm text-gray-500">
                                ¿Estás seguro(a) que quieres rechazar este formulario de viaje? El formulario pasará a la sección de rechazados y el interesado tendrá que rellenar los datos nuevamente.
                            </p>
                        </div>
                    </div>
                </div>
