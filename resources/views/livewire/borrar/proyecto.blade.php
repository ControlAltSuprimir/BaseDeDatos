                    ...
                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                        ...
                        <div class="mt-2">
                            <p class="text-sm text-gray-500">
                                ¿Estás seguro(a) que quieres borrar a este proyecto? Todos los datos serán relacionados a
                                esta proyecto será permanentemente removida de la base de datos como también el registro
