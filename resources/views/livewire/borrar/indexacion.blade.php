<div class="px-4 py-3 bg-gray-50 text-right sm:px-6">
    ...
    <div class="@if (!$showModal) hidden @endif fixed z-10 inset-0
        overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true">
                    ...
                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                        ...
                        <div class="mt-2">
                            <p class="text-sm text-gray-500">
                                ¿Estás seguro(a) que quieres borrar esta indexación? Todos los datos serán relacionados a
                                esta indexación será permanentemente removida de la base de datos. El registro
                                de esta acción y el usuario que la ejecuta serán guardados.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="mt-5 sm:mt-4 sm:ml-10 sm:pl-4 sm:flex">
                        <button type="button" wire:click.prevent="delete({{ $products }})"
