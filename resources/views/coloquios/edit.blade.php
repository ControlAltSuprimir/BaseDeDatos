<x-app-layout>
    ...
    <div class="space-y-6 sm:px-6 lg:px-0 lg:col-span-9">
        <div>
            ...
            <form action="{{ route('coloquios.update', $data['coloquio']->id) }}" method="POST">
                    ...
                    <div class="bg-white py-6 px-4 sm:p-6">
                        ...
                        <div class="col-span-4 sm:col-span-1" gap-6>
                            ...
                            <input type="text" name="titulo" id="titulo" autocomplete="cc-exp"
                                ...
                                value="{{ $data['coloquio']->titulo }}" placeholder="" required>
                        </div>
                        ...
                        <div class="col-span-4 sm:col-span-1" gap-6>
                            <select name="institucion"
                                ...
                                @foreach ($data['instituciones'] as $institucion)
                                    @if ($institucion->id != $data['coloquio']->id_institucion)
        ...
        <?php $edit=$data['coloquio']->id;?>
        @livewire('borrar.borrar_coloquio',['edit' =>$edit])
    </div>
</x-app-layout>
