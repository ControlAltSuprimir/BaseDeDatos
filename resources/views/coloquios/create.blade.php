      ...
      <div>
        ...
        <form action="{{ route('coloquios.store') }}" method="POST">
            ...
            <div class="shadow sm:rounded-md sm:overflow-hidden">
                <div class="bg-white py-6 px-4 sm:p-6">
                    <div>
                        <h2 id="payment_details_heading" class="text-lg leading-6 font-medium text-gray-900">Nombre del/la Expositor/a
                        </h2>
                        <p class="mt-1 text-sm text-gray-500"></p>
                    </div>
            ...
            <div class="shadow sm:rounded-md sm:overflow-hidden">
              <div class="bg-white py-6 px-4 sm:p-6">
                  <div>
                      <h2 id="payment_details_heading" class="text-lg leading-6 font-medium text-gray-900">Institución del/la Expositor/a
                      </h2>
