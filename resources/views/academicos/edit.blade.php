              ...
              <div class="bg-white py-6 px-4 sm:p-6">
                ...
                <div class="mt-6 grid grid-cols-4 gap-6">
                  ...
                  <div class="col-span-4 sm:col-span-1">
                    ...
                    <input type="number" name="telefono_oficina" id="expiration_date" autocomplete="cc-exp" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-gray-900 focus:border-gray-900 sm:text-sm" placeholder="56945994997"
                    value="{{$data['academico']->telefono}}">
                  </div>
